...
/** Recipe holder payload for brewing data owned by PotionBrewing rather than RecipeManager. */
public final class BrewingSyntheticRecipe implements Recipe<RecipeInput> {
    private final AdvancedAlloyFurnaceRecipe convertedRecipe;

    public BrewingSyntheticRecipe(AdvancedAlloyFurnaceRecipe convertedRecipe) {
