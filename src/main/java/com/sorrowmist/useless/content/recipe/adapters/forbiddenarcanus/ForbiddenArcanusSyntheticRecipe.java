...
/** Recipe wrapper for Ritual data that lives in Forbidden Arcanus' custom registry. */
public final class ForbiddenArcanusSyntheticRecipe implements Recipe<RecipeInput> {
    private final AdvancedAlloyFurnaceRecipe convertedRecipe;

    public ForbiddenArcanusSyntheticRecipe(AdvancedAlloyFurnaceRecipe convertedRecipe) {
