...
/** Recipe-manager payload for Re-Avaritia interactions that are not recipe entries. */
public final class ReAvaritiaSyntheticRecipe implements Recipe<RecipeInput> {
    private final AdvancedAlloyFurnaceRecipe convertedRecipe;

    public ReAvaritiaSyntheticRecipe(AdvancedAlloyFurnaceRecipe convertedRecipe) {
