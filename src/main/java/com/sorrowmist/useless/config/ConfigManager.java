...
public class ConfigManager {
    ...
    // 维度生成配置
    public static final ModConfigSpec.ConfigValue<String> BORDER_BLOCK;
    public static final ModConfigSpec.ConfigValue<String> FILL_BLOCK;
    public static final ModConfigSpec.ConfigValue<String> CENTER_BLOCK;

    // 植物盆生长速度配置
    public static final ModConfigSpec.IntValue BOTANY_POT_GROWTH_MULTIPLIER;

    // 矩阵样板数量配置
    public static final ModConfigSpec.IntValue MATRIX_PATTERN_COUNT;

    // Mekanism 升级配置
    public static final ModConfigSpec.IntValue TIME_MULTIPLIER;
    public static final ModConfigSpec.IntValue ELECTRICITY_MULTIPLIER;
    public static final ModConfigSpec.IntValue CAPACITY_MULTIPLIER;
    public static final ModConfigSpec.IntValue MAX_UPGRADE;

    // Thermal Parallel 配置 - 只在热力系列安装时注册
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_ITEM_CAPACITY;
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_FLUID_CAPACITY;
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_ENERGY_CAPACITY;
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_ITEM_TRANSFER;
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_FLUID_TRANSFER;
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_ENERGY_TRANSFER;
    public static final ModConfigSpec.BooleanValue PARALLEL_INCREASE_ENERGY_CONSUMPTION;
    public static final ModConfigSpec.BooleanValue BASE_MOD_AFFECT_PARALLEL;
    public static final ModConfigSpec.BooleanValue ADD_EXTRA_PARALLEL_AUGMENTS_TO_TAB;
