...
public enum EnumColor {
     ...
     */
    public int getRgb() {
        return (0xFF << 24) | (this.rgbCode[0] << 16) | (this.rgbCode[1] << 8) | this.rgbCode[2];
    }
    ...
    public int[] getRgbCode() {
        return this.rgbCode.clone(); // 返回副本防止外部修改
    }
    ...
    public float[] getRgbFloat() {
        return new float[] {
                this.rgbCode[0] / 255.0f,
                this.rgbCode[1] / 255.0f,
                this.rgbCode[2] / 255.0f
        };
    }
