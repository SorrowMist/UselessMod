...
public class AECraftingPatternProviderRenderer implements BlockEntityRenderer<appeng.blockentity.crafting.PatternProviderBlockEntity> {
    ...
    public AECraftingPatternProviderRenderer(BlockEntityRendererProvider.Context ctx) {}
    ...
    @Override
    public boolean shouldRenderOffScreen(appeng.blockentity.crafting.PatternProviderBlockEntity be) {
        // 始终允许渲染，因为我们需要检查玩家是否手持工具
        return true;
    }
    
    @Override
    public void render(appeng.blockentity.crafting.PatternProviderBlockEntity be, float partialTicks, PoseStack poseStack, 
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers event) {
        // 注册AE2普通样板供应器渲染器
        event.registerBlockEntityRenderer(appeng.core.definitions.AEBlockEntities.PATTERN_PROVIDER, AECraftingPatternProviderRenderer::new);
    }
}