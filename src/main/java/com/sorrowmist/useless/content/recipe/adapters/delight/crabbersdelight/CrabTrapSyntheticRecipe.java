...
/** Holder payload for crab-trap loot tables, which are not RecipeManager recipes. */
public final class CrabTrapSyntheticRecipe implements Recipe<RecipeInput> {
    private final AdvancedAlloyFurnaceRecipe convertedRecipe;

    public CrabTrapSyntheticRecipe(AdvancedAlloyFurnaceRecipe convertedRecipe) {
