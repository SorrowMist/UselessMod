...
@EventBusSubscriber(modid = UselessMod.MOD_ID, value = Dist.CLIENT)
public class UselessClient {
	...
	static void onClientSetup(FMLClientSetupEvent event) {
		...
		UselessMod.LOGGER.info("HELLO FROM CLIENT SETUP");
		UselessMod.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
