...
/** Recipe holder payload for villager offers generated from the current trade tables. */
public final class VillagerTradeSyntheticRecipe implements Recipe<RecipeInput> {
    private final AdvancedAlloyFurnaceRecipe convertedRecipe;

    public VillagerTradeSyntheticRecipe(AdvancedAlloyFurnaceRecipe convertedRecipe) {
