...
/** Recipe-manager payload for conversions built from external recipe data. */
public final class DelightSyntheticRecipe implements Recipe<RecipeInput> {
    private final AdvancedAlloyFurnaceRecipe convertedRecipe;

    public DelightSyntheticRecipe(AdvancedAlloyFurnaceRecipe convertedRecipe) {
